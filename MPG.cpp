...
int main(){   
    ...
    std::cout<<"In metrics, you drove " << kilometers << " kilometers and used " << liters << " liters."<<std::endl;
    std::cout<<"Your fuel efficiency is " << lkm << " liters per 100 kilometers."<<std::endl;
